...
*/}}
{{- define "fraud-detection.imageTag" -}}
...
{{- printf "%s:%s" .Values.image.repository (include "fraud-detection.imageTag" .) }}
{{- end }}

{{/*
Redis URL — prefer explicit url, otherwise build from host/port/db.
*/}}
{{- define "fraud-detection.redisUrl" -}}
{{- if .Values.redis.url }}
{{- .Values.redis.url }}
{{- else }}
