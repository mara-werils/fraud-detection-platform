...
FEATURE_REGISTRY: tuple[FeatureDefinition, ...] = (
    ...
    FeatureDefinition(
        "txn_count_1m", FeatureDtype.INT, FeatureSource.ONLINE, "Transaction count in last 1 minute"
    ),
    FeatureDefinition(
        "txn_count_5m",
        FeatureDtype.INT,
    ...
    FeatureDefinition(
        "txn_count_1h", FeatureDtype.INT, FeatureSource.ONLINE, "Transaction count in last 1 hour"
    ),
    FeatureDefinition(
        "txn_count_24h",
        FeatureDtype.INT,
    ...
    FeatureDefinition(
        "txn_amount_sum_1m",
        FeatureDtype.DECIMAL,
        FeatureSource.ONLINE,
        "Sum of amounts in last 1 minute",
    ),
    FeatureDefinition(
        "txn_amount_sum_5m",
        FeatureDtype.DECIMAL,
        FeatureSource.ONLINE,
        "Sum of amounts in last 5 minutes",
    ),
    FeatureDefinition(
        "txn_amount_sum_1h",
        FeatureDtype.DECIMAL,
        FeatureSource.ONLINE,
        "Sum of amounts in last 1 hour",
    ),
    FeatureDefinition(
        "txn_amount_sum_24h",
        FeatureDtype.DECIMAL,
    ...
    FeatureDefinition(
        "txn_amount_max_1h", FeatureDtype.DECIMAL, FeatureSource.ONLINE, "Max amount in last 1 hour"
    ),
    FeatureDefinition(
        "txn_amount_max_24h",
        FeatureDtype.DECIMAL,
        FeatureSource.ONLINE,
        "Max amount in last 24 hours",
    ),
    # Amount statistics
    FeatureDefinition(
        "amount_running_avg",
    ...
    FeatureDefinition(
        ...
        FeatureDtype.FLOAT,
        FeatureSource.ONLINE,
        "Running max transaction amount",
    ),
    FeatureDefinition(
        "amount_running_sum",
        FeatureDtype.FLOAT,
    ...
    FeatureDefinition(
        "amount_running_count",
        FeatureDtype.INT,
        FeatureSource.ONLINE,
        "Running count of all transactions",
    ),
    FeatureDefinition(
        "amount_zscore",
        FeatureDtype.FLOAT,
    ...
    FeatureDefinition(
        ...
        FeatureDtype.BOOL,
        FeatureSource.ONLINE,
        "Whether merchant was never seen before",
    ),
    FeatureDefinition(
    ...
    FeatureDefinition(
        ...
        FeatureDtype.FLOAT,
        FeatureSource.ONLINE,
        "Distance from last transaction in km",
    ),
    FeatureDefinition(
        "distance_from_home_km",
        FeatureDtype.FLOAT,
        FeatureSource.ONLINE,
        "Distance from usual location in km",
    ),
    FeatureDefinition(
        "last_latitude", FeatureDtype.FLOAT, FeatureSource.ONLINE, "Latitude of last transaction"
    ),
    FeatureDefinition(
        "last_longitude", FeatureDtype.FLOAT, FeatureSource.ONLINE, "Longitude of last transaction"
    ),
    # Device features
    FeatureDefinition(
        "is_new_device",
        FeatureDtype.BOOL,
        FeatureSource.ONLINE,
        "Whether device was never seen before",
    ),
    FeatureDefinition(
        "unique_devices_count", FeatureDtype.INT, FeatureSource.ONLINE, "Total unique devices used"
    ),
    # Offline / aggregate features
    FeatureDefinition(
        "merchant_fraud_rate",
        FeatureDtype.FLOAT,
        FeatureSource.OFFLINE,
        "Historical fraud rate for merchant",
    ),
    FeatureDefinition(
        "user_historical_fraud_count",
        FeatureDtype.INT,
        FeatureSource.OFFLINE,
        "Number of past fraudulent txns for user",
    ),
    FeatureDefinition(
    ...
    FeatureDefinition(
        "user_avg_daily_txn_count",
        FeatureDtype.FLOAT,
        FeatureSource.OFFLINE,
        "Average daily transactions historically",
    ),
    FeatureDefinition(
        "user_avg_daily_amount",
        FeatureDtype.FLOAT,
        FeatureSource.OFFLINE,
        "Average daily spend historically",
    ),
)
...
def get_feature_definitions(source: FeatureSource | None = None) -> Sequence[FeatureDefinition]:
    ...
    return tuple(
        f for f in FEATURE_REGISTRY if f.source == source or f.source == FeatureSource.BOTH
    )
