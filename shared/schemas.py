...
class Transaction(BaseSchema):
    ...
    amount: Decimal = Field(..., ge=0, le=Decimal("999_999_999.99"), description="Transaction amount")
    currency: str = Field(default="USD", min_length=3, max_length=3, pattern=r"^[A-Z]{3}$", description="ISO 4217 currency code")
    transaction_type: TransactionType = Field(..., description="Type of transaction")
    merchant_id: str | None = Field(default=None, max_length=128, description="Merchant identifier")
    merchant_category: str | None = Field(default=None, max_length=64, description="Merchant category code")
    card_number_hash: str | None = Field(default=None, max_length=128, description="Hashed card number")
    ip_address: str | None = Field(default=None, max_length=45, description="Source IP address")
    device_id: str | None = Field(default=None, max_length=256, description="Device fingerprint")
